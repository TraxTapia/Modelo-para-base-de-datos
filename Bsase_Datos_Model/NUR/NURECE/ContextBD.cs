...
namespace Bsase_Datos_Model.NUR.NURECE
{
    public partial class ContextBD : DbContext
    {
        ...
        public virtual DbSet<EntidadFederativaInfonavit> EntidadFederativaInfonavit { get; set; }
        public virtual DbSet<Error_Log_SQL> Error_Log_SQL { get; set; }
        public virtual DbSet<Especialidad> Especialidad { get; set; }
        public virtual DbSet<EspecialidadesECEvsMediKit> EspecialidadesECEvsMediKit { get; set; }
        public virtual DbSet<EspecialidadInfonavit> EspecialidadInfonavit { get; set; }
        ...
        public virtual DbSet<IndicacionesTomaMedicamento> IndicacionesTomaMedicamento { get; set; }
        ...
        public virtual DbSet<MedicalNetworkInfonavit> MedicalNetworkInfonavit { get; set; }
        ...
        public virtual DbSet<MunicipioInfonavit> MunicipioInfonavit { get; set; }
        public virtual DbSet<NivelAtencionInfonavit> NivelAtencionInfonavit { get; set; }
        public virtual DbSet<Parentesco> Parentesco { get; set; }
        public virtual DbSet<PlazaInfonavit> PlazaInfonavit { get; set; }
        ...
        public virtual DbSet<ProveedoresInfonavit> ProveedoresInfonavit { get; set; }
        public virtual DbSet<Red> Red { get; set; }
        public virtual DbSet<RedMedicaInfonavitXLS> RedMedicaInfonavitXLS { get; set; }
        ...
        public virtual DbSet<Restitucion> Restitucion { get; set; }
        ...
        public virtual DbSet<ServiciosenCoberturaXAfiliadoXEspecialidad> ServiciosenCoberturaXAfiliadoXEspecialidad { get; set; }
        ...
        public virtual DbSet<UnidadesDeTiempo> UnidadesDeTiempo { get; set; }
        public virtual DbSet<Usuarios> Usuarios { get; set; }
        public virtual DbSet<ViasDeAdmonMedicamento> ViasDeAdmonMedicamento { get; set; }
        ...
        public virtual DbSet<CopagoECEvsPurchaserplan> CopagoECEvsPurchaserplan { get; set; }
        ...
        public virtual DbSet<Reembolsos02082023> Reembolsos02082023 { get; set; }
        public virtual DbSet<RegistrosManuales19082023Temporal> RegistrosManuales19082023Temporal { get; set; }
        ...
        public virtual DbSet<TempDental> TempDental { get; set; }
        public virtual DbSet<TempMedicinaPreventiva> TempMedicinaPreventiva { get; set; }
        public virtual DbSet<TempPagosUnicos20082023> TempPagosUnicos20082023 { get; set; }
        public virtual DbSet<TempRehabilitacion> TempRehabilitacion { get; set; }
        public virtual DbSet<TemServiciosDentales> TemServiciosDentales { get; set; }
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<EntidadFederativaInfonavit>()
                .Property(e => e.EntidadFederativa)
                .IsUnicode(false);

            modelBuilder.Entity<EntidadFederativaInfonavit>()
                .HasMany(e => e.MedicalNetworkInfonavit)
                .WithRequired(e => e.EntidadFederativaInfonavit)
                .HasForeignKey(e => e.Entidad_Id)
                .WillCascadeOnDelete(false);
            ...
            modelBuilder.Entity<EspecialidadesECEvsMediKit>()
                .Property(e => e.Especialidad)
                .IsUnicode(false);
            ...
            modelBuilder.Entity<EspecialidadesECEvsMediKit>()
                .Property(e => e.EspecialidadMediKit)
                .IsUnicode(false);
            ...
            modelBuilder.Entity<EspecialidadesECEvsMediKit>()
                .Property(e => e.idPRODUCCION)
                .IsUnicode(false);

            modelBuilder.Entity<EspecialidadInfonavit>()
                .Property(e => e.Especialidad)
                .IsUnicode(false);

            modelBuilder.Entity<EspecialidadInfonavit>()
                .HasMany(e => e.MedicalNetworkInfonavit)
                .WithRequired(e => e.EspecialidadInfonavit)
            ...
            modelBuilder.Entity<IndicacionesTomaMedicamento>()
                .Property(e => e.Elegibilidad)
                .IsUnicode(false);
            ...
            modelBuilder.Entity<MedicalNetworkInfonavit>()
            ...
            modelBuilder.Entity<MunicipioInfonavit>()
                .Property(e => e.NombreMunicipio)
                .IsUnicode(false);

            modelBuilder.Entity<MunicipioInfonavit>()
                .HasMany(e => e.MedicalNetworkInfonavit)
                .WithRequired(e => e.MunicipioInfonavit)
                .HasForeignKey(e => e.Municipio_Id)
                .WillCascadeOnDelete(false);

            modelBuilder.Entity<NivelAtencionInfonavit>()
                .Property(e => e.NivelAtencion)
                .IsUnicode(false);

            modelBuilder.Entity<NivelAtencionInfonavit>()
                .HasMany(e => e.MedicalNetworkInfonavit)
                .WithRequired(e => e.NivelAtencionInfonavit)
                .HasForeignKey(e => e.NivelAtencion_Id)
                .WillCascadeOnDelete(false);
            ...
            modelBuilder.Entity<PlazaInfonavit>()
                .Property(e => e.Plaza)
                .IsUnicode(false);

            modelBuilder.Entity<PlazaInfonavit>()
                .HasMany(e => e.MedicalNetworkInfonavit)
                .WithRequired(e => e.PlazaInfonavit)
            ...
            modelBuilder.Entity<ProveedoresInfonavit>()
                .Property(e => e.NombreProveedor)
                .IsUnicode(false);

            modelBuilder.Entity<ProveedoresInfonavit>()
                .HasMany(e => e.MedicalNetworkInfonavit)
                .WithRequired(e => e.ProveedoresInfonavit)
            ...
            modelBuilder.Entity<RedMedicaInfonavitXLS>()
                .Property(e => e.EntidadFederativa)
                .IsUnicode(false);
            ...
            modelBuilder.Entity<RedMedicaInfonavitXLS>()
                .Property(e => e.DescuentoLaboratorioGabinete)
                .IsUnicode(false);
            ...
            modelBuilder.Entity<Restitucion>()
                .Property(e => e.MontoUnitarioInicial)
                .HasPrecision(18, 4);

            modelBuilder.Entity<Restitucion>()
                .Property(e => e.MontoTotalInicial)
                .HasPrecision(18, 4);

            modelBuilder.Entity<Restitucion>()
                .Property(e => e.CPTInicial)
                .IsUnicode(false);

            modelBuilder.Entity<Restitucion>()
                .Property(e => e.MontoUnitarioFinal)
                .HasPrecision(18, 4);

            modelBuilder.Entity<Restitucion>()
                .Property(e => e.MontoTotalFinal)
                .HasPrecision(18, 4);

            modelBuilder.Entity<Restitucion>()
                .Property(e => e.CPTFinal)
                .IsUnicode(false);
            ...
            modelBuilder.Entity<ServiciosenCoberturaXAfiliadoXEspecialidad>()
                .Property(e => e.CodAfiliado)
                .IsUnicode(false);
            ...
            modelBuilder.Entity<UnidadesDeTiempo>()
                .Property(e => e.UnidadTiempo)
                .IsUnicode(false);
            ...
            modelBuilder.Entity<ViasDeAdmonMedicamento>()
                .Property(e => e.ViaDeAdmimistracion)
                .IsUnicode(false);
            ...
            modelBuilder.Entity<CopagoECEvsPurchaserplan>()
                .Property(e => e.Descripcion)
                .IsUnicode(false);

            modelBuilder.Entity<CopagoECEvsPurchaserplan>()
                .Property(e => e.Purchaserplan)
                .IsUnicode(false);
            ...
            modelBuilder.Entity<Reembolsos02082023>()
                .Property(e => e.cve_espec)
                .HasPrecision(19, 4);

            modelBuilder.Entity<RegistrosManuales19082023Temporal>()
                .Property(e => e.no_fac)
                .IsUnicode(false);
            ...
            modelBuilder.Entity<TempDental>()
                .Property(e => e.cve_prov)
                .IsUnicode(false);
            ...
            modelBuilder.Entity<TempMedicinaPreventiva>()
                .Property(e => e.no_fac)
                .IsUnicode(false);
            ...
            modelBuilder.Entity<TempPagosUnicos20082023>()
                .Property(e => e.cve_espec)
                .IsUnicode(false);
            ...
            modelBuilder.Entity<TempRehabilitacion>()
                .Property(e => e.cve_prov)
                .IsUnicode(false);
            ...
            modelBuilder.Entity<TemServiciosDentales>()
                .Property(e => e.cve_espec)
                .IsUnicode(false);
