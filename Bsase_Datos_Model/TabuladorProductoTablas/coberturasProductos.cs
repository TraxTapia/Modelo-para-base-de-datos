namespace Bsase_Datos_Model.TabuladorProductoTablas
{
    ...
    [Table("saMediaccess.coberturasProductos")]
    public partial class coberturasProductos
    {
        [Key]
        ...
        public bool? RequierePaseEspecialidad { get; set; }

        public bool? RefiereEspecialidad { get; set; }

        public bool? ConsultasRestringidas { get; set; }
    }
}
