namespace Bsase_Datos_Model.SASSV2.mediaccess
{
    ...
    public partial class tmpReporteProveedores
    {
        [Key]
        [Column(Order = 0)]
        ...
        [Key]
        [Column("PERSONA JURIDICA", Order = 3)]
        [StringLength(6)]
        public string PERSONA_JURIDICA { get; set; }

        [Key]
        [Column("TIPO_MOVIMIENTO ", Order = 4)]
        [StringLength(1)]
        ...
        [Key]
        [Column("TIPO DE FARMACIA", Order = 6)]
        [DatabaseGenerated(DatabaseGeneratedOption.None)]
        ...
        [Key]
        [Column("ZONA QUIRURJICA", Order = 9)]
        [StringLength(2)]
        public string ZONA_QUIRURJICA { get; set; }

        [Key]
        [Column("FECHA MODIFICACION", Order = 10)]
        [StringLength(1)]
        ...
        [Key]
        [Column("COSTO CONSULTA CONVENIDO", Order = 11)]
        [StringLength(1)]
